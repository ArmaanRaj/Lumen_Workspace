...
import { Layout, LayoutList, Loader, Router, Users } from 'lucide-react';
...
const MeetingRoom = () => {
  ...
  const CallLayout = () => {
    ...
    else if (layout === 'speaker-right') return <SpeakerLayout participantsBarPosition="left" />
    else return <SpeakerLayout participantsBarPosition="right" />
  }
  return (
